      ...
      <div v-for="item in actives" class="active-list" :key="item.node.id">
        ...
        <div class="active-content">
          ...
          <div class="imgs-main">
            <div
              class="imgs-div"
              v-for="imgs in item.node.targets[0].pictures"
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/7/6/1646da75cd08b439?w=700&h=384&f=jpeg&s=25374",
              username: "Fridayo",
              company: "某云计算小公司",
              jobTitle: "python"
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/12/21/167cf06152aefac3?w=694&h=693&f=jpeg&s=344764",
              username: "newArray",
              company: "易宝支付有限公司",
              jobTitle: "前端开发er"
            }
          ...
          targets: [
            {
              ...
              content:
                "今天领导给我丢了一堆前端简历，看了一下实在没有让我一眼心动的。简历不应该是内容硬堆上去的。希望自己以后的简历可以让人眼前一亮。为之奋斗吧！",
              ...
              viewerHasLiked: false,
              pictures: [],
              topic: { id: "5b6eb8b3092dcb61bd728956", title: "人在职场" },
              user: {
                id: "59f99ce3f265da43247fc40c",
                avatarLarge:
                  "https://user-gold-cdn.xitu.io/2018/12/21/167cf06152aefac3?w=694&h=693&f=jpeg&s=344764",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/12/6/1678198b829e9cd1?w=245&h=231&f=jpeg&s=15412",
              username: "creanme",
              company: "",
              jobTitle: "打杂工程师"
            }
          ...
          targets: [
            {
              ...
              content:
                "总算发现vscode上面的代码粘贴到onenote简单的办法了，那就是使用ctrl shift p然后使用Convert Indention to Taps把空格转换为tab符号（右下角点击切换没用），然后就可以复制粘贴到onenote里面了😂",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/6/9/163e4713c84fb36c?w=748&h=446&f=png&s=355312",
              username: "戴小超",
              company: "",
              jobTitle: "web前端"
            }
          ...
          targets: [
            {
              ...
              content:
                "现在的人套路都太多了，我跟你推心置腹，你觉得我对你居心不良，我对你君子之交淡如水，你觉得我装逼高冷没人情味，WQNMD",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/3/9/162084193cb4922d?w=1920&h=1080&f=jpeg&s=176715",
              username: "史前图腾",
              company: "不想说...",
              jobTitle: "苹果API搬运工"
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2016/11/30/70ebba657e166fedea26c628bfcac2b0",
              username: "仁元",
              company: "Tencent",
              jobTitle: "web前端高级工程师"
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "http://tva2.sinaimg.cn/crop.0.0.180.180.180/663aa05ajw1e8qgp5bmzyj2050050aa8.jpg",
              username: "网路冷眼",
              company: "",
              jobTitle: ""
            }
          ...
          targets: [
            {
              ...
              content:
                "【Try running deep learning inference on Raspberry Pi】 http://t.cn/E4JzEVY  尝试在Raspberry Pi上运行深度学习推理。",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/7/2/16459c1e94f61f29?w=500&h=500&f=jpeg&s=26496",
              username: "清蒸不是水煮",
              company: "掘金",
              jobTitle: "沸点运营"
            }
          ...
          targets: [
            {
              ...
              topic: { id: "5bf52da5092dcb0a7dcc7092", title: "掘金官方" },
              user: {
                id: "5b39bd7de51d4558d43ff06d",
                avatarLarge:
                  "https://user-gold-cdn.xitu.io/2018/7/2/16459c1e94f61f29?w=500&h=500&f=jpeg&s=26496",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2017/5/4/3cae4b307e84f06cb3acb4b8ac67792f",
              username: "杨昕霖",
              company: "掘金",
              jobTitle: "产品负责人"
            }
          ...
          targets: [
            {
              ...
              content:
                "我就想问大家都是红帽子，我这里看怎么就是绿帽子，是因为我在此条信息下方评论了“来一顶绿帽子”，就能红帽变绿帽。体验一下？",
              ...
              topic: { id: "5c106be9092dcb2cc5de7257", title: "上班摸鱼" },
              user: {
                id: "554ceae2e4b0d9bd70f50524",
                avatarLarge:
                  "https://user-gold-cdn.xitu.io/2017/5/4/3cae4b307e84f06cb3acb4b8ac67792f",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/12/14/167aa7053c198272?w=800&h=600&f=png&s=199144",
              username: "科技新闻搬运工",
              company: "News",
              jobTitle: "互联网新鲜事播报员"
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/12/21/167d053852443a4d?w=768&h=768&f=jpeg&s=72691",
              username: "幸福村的张二哥",
              company: "Alipay",
              jobTitle: "打谷子能手"
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/3/28/1626b212b094caee?w=578&h=578&f=png&s=25817",
              username: "LeviDing",
              company: "掘金",
              jobTitle: "翻译计划膜法师"
            }
          ...
          targets: [
            {
              ...
              topic: { id: "5c1cca46092dcb63cb427817", title: "好文推荐" },
              user: {
                id: "589881b7128fe1006cbbacec",
                avatarLarge:
                  "https://user-gold-cdn.xitu.io/2018/3/28/1626b212b094caee?w=578&h=578&f=png&s=25817",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/9/23/16603bda17548e9a?w=1019&h=1019&f=jpeg&s=100100",
              username: "陈大鱼头",
              company: "打杂的",
              jobTitle: "web前端工程师"
            }
          ...
          targets: [
            {
              ...
              topic: { id: "5af9bd18092dcb355ce35709", title: "一图胜千言" },
              user: {
                id: "576b433bd342d30057aaa1e9",
                avatarLarge:
                  "https://user-gold-cdn.xitu.io/2018/9/23/16603bda17548e9a?w=1019&h=1019&f=jpeg&s=100100",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2017/7/13/bfe29d9a6c356c6f60c2d380c99dc76b",
              username: "gongph",
              company: "搜狐畅游",
              jobTitle: "搬运工"
            }
          ...
          targets: [
            {
              ...
              content:
                "#有些话只能在这里说# 一周前，我：把这块代码用递归重构下吧！ 回答：都能实现干嘛要重构？！ 万万没想到，今天我还是 pull 到了同事尚未重构的代码。无语。。。",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/11/19/1672a72d3c77abbb?w=640&h=640&f=jpeg&s=48679",
              username: "美术课代表",
              company: "",
              jobTitle: ""
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/9/29/16623feb09b155c1?w=1194&h=895&f=jpeg&s=272354",
              username: "数据图表控",
              company: "掘金",
              jobTitle: "数据分析员"
            }
          ...
          actors: [
            {
              ...
              avatarLarge:
                "https://user-gold-cdn.xitu.io/2018/7/31/164eef916fac8bac?w=1239&h=1209&f=png&s=371545",
          ...
          targets: [
            {
              ...
              content:
                "Choerodon猪齿鱼即将发布新版本，会新增状态机设置、应用权限控制、配置映射功能、自动化测试等功能。感兴趣的小伙伴上我们GitHub安装体验吧👇",
          ...
          actors: [
            {
              ...
              avatarLarge:
                "http://tva2.sinaimg.cn/crop.0.0.180.180.180/4b4d632fjw1e8qgp5bmzyj2050050aa8.jpg",
              username: "张鑫旭",
              company: "阅文集团",
              jobTitle: "前端打杂师"
            }
          ...
          targets: [
            {
              ...
              content:
                "阅文年底急招职位，设计师，产品经理，技术开发，都缺，有意可以简历至 zhangxinxu@yuewen.com ，可以帮忙内推，前端职位无论合不合适，都会回复。",
              ...
              topic: { id: "5abb61e1092dcb4620ca3322", title: "内推信息" },
              user: {
                id: "595315e7f265da6c322dc6c6",
                avatarLarge:
                  "http://tva2.sinaimg.cn/crop.0.0.180.180.180/4b4d632fjw1e8qgp5bmzyj2050050aa8.jpg",
